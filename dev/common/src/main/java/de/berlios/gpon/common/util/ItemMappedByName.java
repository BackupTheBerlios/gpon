...
public class ItemMappedByName 
  extends AbstractMappedItem
{
  public ItemMappedByName(Item item)
  {
    init(item);
  }
  ...
  public AbstractMappedItemType getMappedItemType(ItemType itemType) 
  {
	  return new ItemTypeMappedByName(itemType);
  }  
}
