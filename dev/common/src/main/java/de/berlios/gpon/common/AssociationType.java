...
public class AssociationType {
  ...
  public String toString() {
    String s = "id=" + id + " name=" + name + " multiplicity=" + multiplicity +
               " description=" + description + " baseAssociationTypeId=" +
               baseAssociationTypeId + " itemARoleName=" +
               itemARoleName + " itemBRoleName=" + itemBRoleName;
    return s;
  }
