...
YAHOO.util.WidthResizer.prototype.onDrag = function(e) {
    ...
    var newPosY = YAHOO.util.Dom.getY(this.getDragEl());
    
    YAHOO.log("DragEL X: "+newPos+" Y: "+newPosY,"warn");
...
YAHOO.register("datatable", YAHOO.widget.DataTable, {version: "2.2.2", build: "204"});
