...
public class UniversalDecorator extends TableDecorator 
{
  ...
  public String getEditAndDeleteLink()
    ...
    if (id != null) {
      return "<a href=\"edit.jsp?itemId=" + id + "\">&Auml;ndern</a>"+
             "&nbsp;<a href=\"delete.jsp?itemId=" + id + "\">L&ouml;schen</a>";
    } else {
  ...
  public String getPrepareEditAndDeleteLink()
    ...
    if (id != null) {
      return "<a href=\"pre-edit.do?itemId=" + id + "\">&Auml;ndern</a>"+
             "&nbsp;<a href=\"pre-delete.do?itemId=" + id + "\">L&ouml;schen</a>";
    } else {
      return "##id property empty##";  
    }
	}
  ...
  if (id != null) {
    return "<a href=\"pre-edit.do?objectId=" + id + "\">&Auml;ndern</a>"+
           "&nbsp;<a href=\"pre-delete.do?objectId=" + id + "\">L&ouml;schen</a>";
  } else {
    return "##id property empty##";  
  }
	}
  ...
  public String getViewDetailLink()
    ...
    if (id != null) {
      return "<a target=\"_blank\" href=\"itemDetails.do?decorator=popup&confirm=true&record=start&renderMode=html&itemId=" + id + "\">Detail</a>";
    } else {
      return "##id property empty##";  
    }
	}
  ...
  public String getViewTypeDetailLink()
    ...
    if (id != null) {
      return "<a target=\"_blank\" href=\"itemTypeDetails.do?decorator=popup&confirm=true&record=start&renderMode=html&itemId=" + id + "\">Detail</a>";
    } else {
      return "##id property empty##";  
    }
	}
    ...
    try {
     multiplicity = (String)LookupUtil.getBeanProperty(lObject,"multiplicity");
    } catch (Exception ex) {
    ...
    if (multiplicity != null) {
       if (AssociationType.MultiplicityConstants.ONE_TO_MANY.equals(multiplicity)) {
        return "1:N";
       } else if (AssociationType.MultiplicityConstants.MANY_TO_MANY.equals(multiplicity)) { 
        return "M:N";
       } else {
        return "?";
       }
